...
namespace OceanStore.DataAccesLayer.Migrations
{
    ...
    [Migration("20230107081210_CreateAmountTable")]
    partial class CreateAmountTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OceanStore.DataAccesLayer.Models.Ammount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OceanStore.DataAccesLayer.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OceanStore.DataAccesLayer.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OceanStore.DataAccesLayer.Models.Category", b =>
                {
                    b.HasOne("OceanStore.DataAccesLayer.Models.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("OceanStore.DataAccesLayer.Models.Employee", b =>
                {
                    b.HasOne("OceanStore.DataAccesLayer.Models.Position", "Position")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("OceanStore.DataAccesLayer.Models.ProductCategory", b =>
                {
                    b.HasOne("OceanStore.DataAccesLayer.Models.Category", "Category")
                        .WithMany("ProductCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OceanStore.DataAccesLayer.Models.Product", "Product")
                        .WithMany("ProductCategories")
            ...
            modelBuilder.Entity("OceanStore.DataAccesLayer.Models.ProductDetail", b =>
                {
                    b.HasOne("OceanStore.DataAccesLayer.Models.Product", "Product")
                        ...
                        .HasForeignKey("OceanStore.DataAccesLayer.Models.ProductDetail", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
